...
//   return (
//     <div
//       className="max-w-sm mx-auto bg-white shadow-md rounded-2xl overflow-hidden border border-gray-300 cursor-pointer hover:shadow-lg transition-shadow duration-300 lg:min-w-[350px] min-w-[300px]"
...
//         />
//         <div className="absolute top-3 left-3 bg-[#4F46E5] text-white text-xs px-2 py-1 rounded-full  font-bold">
//           {property.location || defaultValue}
//         </div>

//         <div className="absolute top-3 right-3 bg-white text-[#4F46E5] text-sm px-2 py-1 rounded-full   font-bold shadow-sm">
...
//             {/* Display "Commercial" badge if isCommercial is true */}
//             {property.isCommercial && (
//               <span className="bg-gray-500 mt- text-white text-xs px-2 py-1 rounded-full font-semibold">
//                 Commercial
//               </span>
//             )}
//           </div>
...
//           </button>
//           <button
//             className="flex items-center justify-center bg-green-500 text-white py-1.5 px-2 rounded-xl hover:bg-green-400 transition-colors duration-200"
